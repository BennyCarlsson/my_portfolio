        ...
        <div id="aboutContentDiv">
          <Paper id="paperContent" zDepth={2}>
            ...
            <h2>Hello World!</h2>
              ...
              Moved to Kalmar 2012 to study software development at Linnaeus University and now I live in small town close to Växjö working full time writing java. During my free time I try to spend as
              much time possible writing code and other cool stuff to show off on the internet.</p>
