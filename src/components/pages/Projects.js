    ...
    return(
      <Card style={style} className="cardDiv">
        ...
        <CardText className="CardTextDiv">
          ...
          Our weapon of choice were React,Redux and old-fashioned HTML tables. 2500 table cells was used during this project and no ducks got hurt. React and HTML tables might not be te tool for creating a game but we were so preoccupied with whether we could,
