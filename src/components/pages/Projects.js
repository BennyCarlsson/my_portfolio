    ...
    return (
      <Card style={style} className="cardDiv">
        ...
        <CardText className="cardTextDiv">
          Lorem Ipsum Generator for your android device. Created with{" "}
          <span className="heavyFont">React Native + Redux.</span> Available for
          Android in the{" "}
          <a
    ...
    return (
      <Card style={style} className="cardDiv">
        ...
        <CardText className="cardTextDiv">
          ...
          were <span className="heavyFont">React, Redux</span> and old-fashioned{" "}
          <span className="heavyFont">HTML tables,</span> 2500 table cells was
          used. No ducks were harmed in the making of this project. React and
          HTML tables might not be the tool for creating a game but{" "}
          <span className="heavyFont">
            we were so preoccupied with whether we could, we didn't stop to
            think if we should.
          </span>
        </CardText>
        <CardActions style={styleCardFooter}>
    ...
    return (
      <Card style={style} className="cardDiv">
        ...
        <CardText className="cardTextDiv">
          ...
          Kalmar. An Android application made using{" "}
          <span className="heavyFont">Java</span> and Android studio with small
          amount of <span className="heavyFont">php</span> for backend with a{" "}
          <span className="heavyFont">MySQL</span> database. Use the gps in your
          phone to make sure you or your friends gets home safely! Available
          free for Android in the{" "}
          <a
    ...
    return (
      <Card style={style} className="cardDiv">
        ...
        <CardText className="cardTextDiv">
          ...
          made with <span className="heavyFont">ReactJS</span> . Works best on
          mobile
        </CardText>
        <CardActions style={styleCardFooter}>
  ...
  render() {
    return (
      <Card style={style} className="cardDiv">
        ...
        <CardText className="cardTextDiv">
          <span className="heavyFont">Hacktoberfest</span> is a month-long
          celebration of{" "}
          <span className="heavyFont">open source software.</span>
          This project created together with{" "}
          <a href="https://github.com/rs222kn" target="_blank">
            Richard
          </a>{" "}
          was our contribution to the open source celebration. With over{" "}
          <span className="heavyFont">800 contributors, 1800 forks</span> and{" "}
          <span className="heavyFont">2000 pull request</span> we managed to
          create an horrendous website. The website itself is a guide on how to
          get started with contributing to open source projects. At the same
          time being the project that you can contribute to by adding more
  ...
  render() {
    return (
      <Card style={style} className="cardDiv">
        ...
        <CardText className="cardTextDiv">
          Check out the code for this website that I created using{" "}
          <span className="heavyFont">React.js.</span>
        </CardText>
        <CardActions style={styleCardFooter}>
